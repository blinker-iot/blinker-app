...
import { Layout2EditcomponentPage } from './layout2-editcomponent';
...
@NgModule({
  declarations: [
    Layout2EditcomponentPage,
  ],
  imports: [
    IonicPageModule.forChild(Layout2EditcomponentPage),
    ComponentsModule,
...
export class Layout2EditcomponentPageModule {}
