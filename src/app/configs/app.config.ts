export const CONFIG = {
    ...
    USER_AGREEMENT: "https://blockly.yiyu.pro/agreement/TERMS-zh.md",
    PRIVACY_POLICY: "https://blockly.yiyu.pro/agreement/PRIVACY-zh.md",
    DEV_AGREEMENT: "https://iot.yiyu.pro/public/develop.md",
    UPDATE_FILE: "https://iot.yiyu.pro/public/update.json",
    ICON_FILE: "https://iot.yiyu.pro/public/icon.json",
